...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Yes</td>
      <td>No</td>
      <td>Patially. Regular HTML does not compile, unless developers manually replace <code>class</code> and <code>for</code> attributes to <code>className</code> and <code>htmlFor</code>.</td>
    </tr>
    <tr>
