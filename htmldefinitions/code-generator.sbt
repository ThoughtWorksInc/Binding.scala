val generateHtmlDefinitions = taskKey[File]("Generate HtmlDefinitions.scala file from HTML Living Standard")
generateHtmlDefinitions := {
  ...
  """
  val file =
    (Compile / scalaSource).value / "com" / "thoughtworks" / "binding" / "htmldefinitions" / "HtmlDefinitions.scala"
  val fileContent = Seq(
